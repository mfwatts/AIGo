...
func TestSmallBoard(t *testing.T) {
	...
	*/
	...
	e_board[0][0] = board.EMPTY
	e_board[0][1] = board.WHITE
	e_board[0][2] = board.EMPTY
	e_board[1][0] = board.WHITE
	e_board[1][1] = board.BLACK
	e_board[1][2] = board.EMPTY
	e_board[2][0] = board.EMPTY
	e_board[2][1] = board.EMPTY
	e_board[2][2] = board.EMPTY
